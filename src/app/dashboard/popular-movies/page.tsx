...
import { getPopularMovies, type TMDBMovie } from "@/lib/tmdb";
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans pb-16 selection:bg-amber-500/30 selection:text-white">
      ...
      <main className="p-4 sm:p-6 md:p-10 max-w-5xl mx-auto mt-4">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-black tracking-tighter text-zinc-100 uppercase">En Popüler Filmler</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {movies.map((movie) => (
            <Link key={movie.id} href={`/dashboard/movie/${movie.id}`} className="group flex flex-col">
